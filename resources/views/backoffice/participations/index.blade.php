            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="datatable-example">
                <thead>
                    <tr>
                        ...
                        <th>Código Lote</th>
                        <th>Producto</th>
                        <th>Total fotos cargadas</th>
                        <th>Total fotos aprovadas</th>
                        <th>Fecha de carga de última imagen</th>
                        <th>Ver imágenes</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $participation->photos->count() }}</td>
                        <td>{{ $participation->approved_photos->count() }}</td>
                        <td>{{ $participation->last_photo ? $participation->last_photo->created_at : "" }}</td>
                        <td><a href="{{ route('participation.show', $participation) }}"><button class="btn btn-alt btn-hover btn-info"><span>Ver imágenes</span><i class="glyph-icon icon-eye"></i></button></a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
